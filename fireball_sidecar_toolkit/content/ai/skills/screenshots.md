...
Use this file as source of truth: `.ai/toolkit/commands/screenshots.md`
...
```bash
uv run --no-sync python -m modules.toolkit.screenshots.route "configure"   # or "view" / "clean"
```

See `.ai/toolkit/instructions/screenshots.md` for the shared-folder rules.
