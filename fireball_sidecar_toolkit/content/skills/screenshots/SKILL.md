...
Use this file as source of truth: `.github/prompts/screenshots.prompt.md`

When the user asks to configure / view / clean screenshots, read that prompt file and follow it.
...
See `.github/instructions/screenshots.instructions.md` for the shared-folder rules.
